...
object Json {
	...
	private def addChildren(children: mutable.ArrayBuffer[JsonNode], name: String, array: ArrayNode) {
		...
		case objectNode: ObjectNode =>
			...
			while (it.hasNext) {
				...
				field.getValue match {
					case array: ArrayNode => addChildren(children, field.getKey, array)
