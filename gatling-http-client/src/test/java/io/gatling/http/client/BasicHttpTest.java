                              ...
                              .test(
                                  ...
                                  new TestListener() {
                                    ...
                                    public void onComplete0() {
                                      ...
                                      assertEquals(
                                          sentBody.length(), Integer.parseInt(contentLengthHeader));
                ...
                withServer(server)
                    .run(
                        server -> {
                          ...
                          Request request =
                              client
                                  .newRequestBuilder(HttpMethod.POST, Uri.create(getTargetUrl()))
                                  .setHeaders(h)
                ...
                withServer(server)
                    .run(
                        server -> {
                          ...
                          Request request =
                              client
                                  .newRequestBuilder(HttpMethod.HEAD, Uri.create(getTargetUrl()))
                                  .build();
                          client
                              .test(
                                  request,
            ...
            client ->
                withServer(server)
                    .run(
                        server -> {
                          server.enqueueEcho();
                          RequestBodyBuilder byteArrayBody =
                              new ByteArrayRequestBodyBuilder("foo".getBytes(UTF_8), null);
                          Request request =
                              client
                                  .newRequestBuilder(HttpMethod.GET, Uri.create(getTargetUrl()))
                                  .setBodyBuilder(byteArrayBody)
                                  .build();
                          client
                              .test(
                                  request,
            ...
            client ->
                withServer(server)
                    .run(
                        server -> {
                          server.enqueueEcho();
                          RequestBodyBuilder byteArraysBody =
                              new StringChunksRequestBodyBuilder(
                                  Collections.singletonList(
                                      new StringWithCachedBytes("foo", UTF_8)));
                          Request request =
                              client
                                  .newRequestBuilder(HttpMethod.GET, Uri.create(getTargetUrl()))
                                  .setBodyBuilder(byteArraysBody)
                                  .build();
                          client
                              .test(
                                  request,
                ...
                withServer(server)
                    .run(
                        server -> {
                          ...
                          RequestBodyBuilder formUrlEncodedBody =
                              new FormUrlEncodedRequestBodyBuilder(formParams);
                          Request request =
                              client
                                  .newRequestBuilder(HttpMethod.GET, Uri.create(getTargetUrl()))
                                  .setBodyBuilder(formUrlEncodedBody)
                                  .build();
                          client
                              .test(
                                  request,
            ...
            client ->
                withServer(server)
                    .run(
                        server -> {
                          server.enqueueEcho();
                          RequestBodyBuilder inputStreamBody =
                              new InputStreamRequestBodyBuilder(
                                  new ByteArrayInputStream("foo".getBytes(UTF_8)));
                          Request request =
                              client
                                  .newRequestBuilder(HttpMethod.GET, Uri.create(getTargetUrl()))
                                  .setBodyBuilder(inputStreamBody)
                                  .build();
                          client
                              .test(
                                  request,
                ...
                withServer(server)
                    .run(
                        server -> {
                          ...
                          multiparts.add(
                              new StringPart("part1", "foo", UTF_8, null, null, null, null, null));
                          multiparts.add(
                              new FilePart(
                                  "part2",
                                  getTestFile(),
                          ...
                          RequestBodyBuilder multipartFormDataBody =
                              new MultipartFormDataRequestBodyBuilder(multiparts);
                          Request request =
                              client
                                  .newRequestBuilder(HttpMethod.GET, Uri.create(getTargetUrl()))
                                  .setBodyBuilder(multipartFormDataBody)
                                  .build();

                          long minimalLength =
                              getTestFile().length()
                                  + 2 * "foo".length()
                                  + 3 * 30; // file + 2 * foo + 3 * multipart boundary
