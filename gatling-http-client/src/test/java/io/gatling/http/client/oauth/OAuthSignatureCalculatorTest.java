...
class OAuthSignatureCalculatorTest {
    ...
    String signatureBaseString =
        new OAuthSignatureCalculatorInstance()
            .signatureBaseString( //
                ...
                request.getMethod(),
                request.getUri(),
                request.getBody() instanceof FormUrlEncodedRequestBody
                    ? ((FormUrlEncodedRequestBody) request.getBody()).getContent()
                    : null,
                137131201,
                "7d8f3e4a")
            .toString();
        ...
        new OAuthSignatureCalculatorInstance()
            .signatureBaseString( //
                ...
                request.getBody() instanceof FormUrlEncodedRequestBody
                    ...
                    : null,
                137131201,
                Utf8UrlEncoder.percentEncodeQueryElement("ZLc92RAkooZcIO/0cctl0Q=="))
            .toString();
  ...
  void testGetWithRequestBuilder() throws Exception {
    ...
    assertEquals(
        "http://photos.example.net/photos?file=vacation.jpg&size=original", req.getUri().toUrl());
  }
  ...
  void testSignatureGenerationWithAsteriskInPath()
    ...
    String generatedAuthHeader =
        new OAuthSignatureCalculatorInstance()
            .computeAuthorizationHeader(
                consumerKey, requestToken, actualSignature, timestamp, nonce);
    assertTrue(
        generatedAuthHeader.contains("oauth_signature=\"cswi%2Fv3ZqhVkTyy5MGqW841BxDA%3D\""));
  }
