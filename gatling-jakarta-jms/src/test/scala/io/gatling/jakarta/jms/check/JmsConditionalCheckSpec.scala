...
package io.gatling.jakarta.jms.check

import java.util.{ HashMap => JHashMap }

import io.gatling.{ jakarta, BaseSpec, ValidationValues }
...
import io.gatling.jakarta.jms.{ JmsCheck, MockMessage }
import io.gatling.jakarta.jms.check.JmsCheckSupport

import _root_.jakarta.jms.Message
