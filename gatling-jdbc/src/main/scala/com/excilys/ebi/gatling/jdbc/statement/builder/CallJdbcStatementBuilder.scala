...
object CallJdbcStatementBuilder {
	...
	def apply(statementName: EvaluatableString,statement: String) = new CallJdbcStatementBuilder(JdbcAttributes(statementName,statement,StatementType.CALL,Nil,None))
}
