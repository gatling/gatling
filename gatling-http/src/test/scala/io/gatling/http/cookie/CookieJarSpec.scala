...
class CookieJarSpec extends Specification {
  ...
  "storeCookies" should {
    ...
    "return nothing when it's empty" in {
      new CookieJar(Map.empty).get(UriComponents.create("http://docs.foo.com")) must beEmpty
    }
    ...
    "not return cookie when it was set on another domain" in {
      ...
      cookieStore.get(UriComponents.create("http://www.bar.com")) must beEmpty
    }
    ...
    "return the cookie when it was set on the same path" in {
      ...
      cookieStore.get(UriComponents.create("http://www.foo.com/bar/")).length must beEqualTo(1)
    }
    ...
    "return the cookie when it was set on a parent path" in {
      ...
      cookieStore.get(UriComponents.create("http://www.foo.com/bar/baz")).length must beEqualTo(1)
    }
    ...
    "not return the cookie when domain matches but path is different" in {
      ...
      cookieStore.get(UriComponents.create("http://www.foo.com/baz")) must beEmpty
    }
    ...
    "not return the cookie when domain matches but path is a parent" in {
      ...
      cookieStore.get(UriComponents.create("http://www.foo.com")) must beEmpty
    }
    ...
    "return cookie when it was set on a sub domain" in {
      ...
      cookieStore.get(UriComponents.create("http://bar.foo.com")).length must beEqualTo(1)
    }
    ...
    "handle missing domain as request host" in {
      ...
      cookieStore.get(UriComponents.create("http://www.foo.com")).length must beEqualTo(1)
    }
    ...
    "handle the cookie path in a case-sensitive manner (RFC 2965 sec. 3.3.3)" in {
      ...
      cookieStore.get(UriComponents.create("http://www.FoO.com/Foo/bAr")) must beEmpty
    }
    ...
    "not take into account the query parameter in the URI" in {
      ...
      cookieStore.get(UriComponents.create("http://www.foo.com/bar?query2")).length must beEqualTo(1)
    }
    ...
    "should serve the cookies on a subdomain when the domains match" in {
      ...
      cookieStore.get(UriComponents.create("https://y.x.foo.org/")).length must beEqualTo(1)
    }
