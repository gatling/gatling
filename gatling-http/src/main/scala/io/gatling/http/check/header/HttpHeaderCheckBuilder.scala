...
final class HttpHeaderCheckBuilder(headerName: Expression[CharSequence])
    extends CheckBuilder.MultipleFind.Default[HttpHeaderCheckType, Response, String](logActualValueInError = true) {
