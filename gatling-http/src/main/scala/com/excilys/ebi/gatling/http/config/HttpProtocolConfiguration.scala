 ...
 */
class HttpProtocolConfiguration(val baseURL: Option[String], val proxy: Option[ProxyServer], val securedProxy: Option[ProxyServer]) extends ProtocolConfiguration {
