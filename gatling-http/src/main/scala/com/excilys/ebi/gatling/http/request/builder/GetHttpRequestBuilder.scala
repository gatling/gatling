...
object GetHttpRequestBuilder {
	...
	def apply(requestName: EvaluatableString, url: EvaluatableString) = new GetHttpRequestBuilder(HttpAttributes(requestName, "GET", url, Nil, Map.empty, None, None, Nil, None))
}
