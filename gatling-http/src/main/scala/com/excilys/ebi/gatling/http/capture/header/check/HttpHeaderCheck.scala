...
class HttpHeaderCheck(what: Context => String, to: Option[String], checkType: CheckType, expected: Option[String]) extends HttpHeaderCapture(what, to) with HttpCheck {
