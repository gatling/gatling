 ...
 */
abstract class HttpCheck(what: Session => String, how: ExtractorFactory[Response], strategy: CheckStrategy, expected: List[String], saveAs: Option[String], val when: HttpPhase)
