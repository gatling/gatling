...
object DeleteHttpRequestBuilder {
	...
	def apply(requestName: EvaluatableString, url: EvaluatableString) = new DeleteHttpRequestBuilder(HttpAttributes(requestName, "DELETE", url, Nil, Map.empty, None, None, Nil, None))
}
