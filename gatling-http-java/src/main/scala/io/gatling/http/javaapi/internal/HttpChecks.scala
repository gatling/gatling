...
object HttpChecks {
  ...
  private def toScalaCheck(javaCheck: io.gatling.core.javaapi.CheckBuilder): HttpCheck = {
  ...
  def toScalaChecks(javaChecks: ju.List[io.gatling.core.javaapi.CheckBuilder]): Seq[HttpCheck] =
