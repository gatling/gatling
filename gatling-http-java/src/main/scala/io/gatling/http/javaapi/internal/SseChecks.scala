...
object SseChecks {
  ...
  private def toScalaCheck(javaCheck: io.gatling.core.javaapi.CheckBuilder): SseCheck = {
  ...
  def toScalaChecks(javaChecks: ju.List[io.gatling.core.javaapi.CheckBuilder]): Seq[SseCheck] =
