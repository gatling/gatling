...
object JmsChecks {
  ...
  private def toScalaCheck(javaCheck: io.gatling.core.javaapi.CheckBuilder): JmsCheck = {
  ...
  def toScalaChecks(javaChecks: ju.List[io.gatling.core.javaapi.CheckBuilder]): Seq[JmsCheck] =
