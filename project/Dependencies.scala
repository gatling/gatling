...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                  % "4.1.91.Final"
  ...
  private val nettyIoUringLinuxX86           = "io.netty.incubator"                   % "netty-incubator-transport-native-io_uring" % "0.0.19.Final" classifier "linux-x86_64"
  ...
  private val nettyTcNative                  = netty.organization                     % "netty-tcnative-classes"            % "2.0.59.Final"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                  % "2.15.0-rc3"
  ...
  private val bouncyCastle                   = "io.gatling"                           % "gatling-recorder-bc-shaded"        % "1.73"
  private val quicklens                      = "com.softwaremill.quicklens"          %% "quicklens"                         % "1.9.1"
  ...
  private val gatlingEnterprisePluginCommons = "io.gatling"                           % "gatling-enterprise-plugin-commons" % "1.5.2"
