...
object Dependencies {
  ...
  private val akka                           = "com.typesafe.akka"                   %% "akka-actor"                      % "2.5.12"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                % "2.9.5"
  private val sfm                            = ("org.simpleflatmapper"                % "sfm-csv"                         % "3.17.5")
  ...
  private val joddJson                       = "org.jodd"                             % "jodd-json"                       % "4.3.2"
  ...
  private val mockitoCore                    = "org.mockito"                          % "mockito-core"                    % "2.18.3"            % "test"
