...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                % "4.1.63.Final"
  ...
  private val nettyBoringSsl                 = netty.organization                     % "netty-tcnative-boringssl-static" % "2.0.38.Final"
  private val brotli4j                       = "com.aayushatharva.brotli4j"           % "brotli4j"                        % "1.3.2"
  ...
  private val scalaLogging                   = "com.typesafe.scala-logging"          %% "scala-logging"                   % "3.9.3"
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                % "2.12.3"
  ...
  private val zinc                           = ("org.scala-sbt"                      %% "zinc"                            % "1.5.0")
    .exclude("org.jline", "jline")
  ...
  private val caffeine                       = "com.github.ben-manes.caffeine"        % "caffeine"                        % "2.9.0"
  ...
  private val scalaTestScalacheck            = "org.scalatestplus"                   %% "scalacheck-1-15"                 % "3.2.7.0"           % Test
  private val scalaTestMockito               = scalaTestScalacheck.organization      %% "mockito-3-4"                     % "3.2.7.0"           % Test
  private val scalaCheck                     = "org.scalacheck"                      %% "scalacheck"                      % "1.15.3"            % Test
  private val akkaTestKit                    = akka.organization                     %% "akka-testkit"                    % akka.revision       % Test
  private val mockitoCore                    = "org.mockito"                          % "mockito-core"                    % "3.9.0"             % Test
  private val activemqBroker                 = ("org.apache.activemq"                 % "activemq-broker"                 % "5.16.1"            % Test)
  ...
  private val junit                          = "org.junit.jupiter"                    % "junit-jupiter-api"               % "5.7.1"             % Test
  private val junitEngine                    = junit.organization                     % "junit-jupiter-engine"            % junit.revision      % Test
  private val jupiterInterface               = "net.aichler"                          % "jupiter-interface"               % "0.9.0"             % Test

  private val jetty                          = "org.eclipse.jetty"                    % "jetty-server"                    % "9.4.39.v20210325"  % Test
