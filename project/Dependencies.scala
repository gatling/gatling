...
object Dependencies {
  ...
  private val gatlingSharedUtil              = "io.gatling"                          %% "gatling-shared-util"               % "0.0.11"
  private val gatlingSharedModel             = "io.gatling"                          %% "gatling-shared-model"              % "0.0.10"
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                  % "4.1.117.Final"
  ...
  private val spotbugs                       = "com.github.spotbugs"                  % "spotbugs-annotations"              % "4.9.0"
  ...
  private val awsSecretsManager              = "software.amazon.awssdk"               % "secretsmanager"                    % "2.30.2"
  ...
  private val gatlingMqttVersion = "3.13.1.3"
