...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                % "4.1.66.Final"
  ...
  private val brotli4j                       = "com.aayushatharva.brotli4j"           % "brotli4j"                        % "1.5.0"
  ...
  private val logback                        = "ch.qos.logback"                       % "logback-classic"                 % "1.2.5"
