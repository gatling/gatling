...
object Dependencies {
  ...
  private val ahc                            = "org.asynchttpclient"                    % "async-http-client"             % "2.3.0"
  private val ahcNettyUtils                  = "org.asynchttpclient"                    % "async-http-client-netty-utils" % ahc.revision
  private val netty                          = "io.netty"                               % "netty-codec-http"              % "4.1.21.Final"
  ...
  private val saxon                          = "net.sf.saxon"                           % "Saxon-HE"                      % "9.8.0-7"
  ...
  private val sfm                            = ("org.simpleflatmapper"                  % "sfm-csv"                       % "3.15.4")
  ...
  private val joddLagarto                    = "org.jodd"                               % "jodd-lagarto"                  % "4.1.2"
