...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                % "4.1.37.Final"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                % "2.9.9.1"
  private val sfm                            = ("org.simpleflatmapper"                % "lightning-csv"                   % "7.0.0")
  ...
  private val mockitoCore                    = "org.mockito"                          % "mockito-core"                    % "2.28.2"            % "test"
