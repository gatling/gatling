...
object Dependencies { 
  ...
  private val ahc                           = "org.asynchttpclient"                    % "async-http-client-netty3"     % "2.0.0-alpha10"
  private val netty                         = "io.netty"                               % "netty"                        % "3.10.4.Final"
  private val dnsJava                       = "dnsjava"                                % "dnsjava"                      % "2.1.7"
  private val akkaActor                     = "com.typesafe.akka"                     %% "akka-actor"                   % "2.3.13"
  ...
  private val jackson                       = "com.fasterxml.jackson.core"             % "jackson-databind"             % "2.6.2"
