...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                % "4.1.62.Final"
  ...
  private val scalaTestScalacheck            = "org.scalatestplus"                   %% "scalacheck-1-15"                 % "3.2.6.0"           % Test
  private val scalaTestMockito               = scalaTestScalacheck.organization      %% "mockito-3-4"                     % "3.2.5.0"           % Test
