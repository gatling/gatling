...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                % "4.1.75.Final"
  ...
  private val nettyTcNative                  = netty.organization                     % "netty-tcnative-classes" % "2.0.51.Final"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                % "2.13.2.2"
  ...
  private val bouncyCastle                   = "io.gatling"                           % "gatling-recorder-bc-shaded"      % "1.70"
  private val quicklens                      = "com.softwaremill.quicklens"          %% "quicklens"                       % "1.8.4"
  ...
  private val gatlingEnterprisePluginCommons = "io.gatling"                           % "gatling-enterprise-plugin-commons" % "1.0.3-M1"
  ...
  private val mockitoCore                    = "org.mockito"                          % "mockito-core"                    % "4.4.0"            % Test
  private val activemqBroker                 = ("org.apache.activemq"                 % "activemq-broker"                 % "5.16.4"            % Test)
  ...
  private val jetty                          = "org.eclipse.jetty"                    % "jetty-server"                    % "9.4.45.v20220203"  % Test
