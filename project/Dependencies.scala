...
object Dependencies { 
  ...
  private val ahc                           = "org.asynchttpclient"                    % "async-http-client"             % "2.1.0-alpha8"
  ...
  private val slf4jApi                      = "org.slf4j"                              % "slf4j-api"                     % "1.7.23"
  ...
  private val jackson                       = "com.fasterxml.jackson.core"             % "jackson-databind"              % "2.8.7"
  ...
  private val jmh                            = "org.openjdk.jmh"                        % "jmh-core"                     % "1.17.4"
