...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                % "4.1.34.Final"
  ...
  private val nettyBoringSsl                 = netty.organization                     % "netty-tcnative-boringssl-static" % "2.0.22.Final"
  ...
  private val saxon                          = "net.sf.saxon"                         % "Saxon-HE"                        % "9.9.1-2"
  ...
  private val sfm                            = ("org.simpleflatmapper"                % "lightning-csv"                   % "6.4.0")
  ...
  private val joddJson                       = "org.jodd"                             % "jodd-json"                       % "5.0.10"
  ...
  private val pebble                         = "io.pebbletemplates"                   % "pebble"                          % "3.0.8"

  // Test dependencies
  private val scalaTest                      = "org.scalatest"                       %% "scalatest"                       % "3.0.6"             % "test"
  ...
  private val mockitoCore                    = "org.mockito"                          % "mockito-core"                    % "2.25.0"            % "test"
  private val activemqBroker                 = "org.apache.activemq"                  % "activemq-broker"                 % "5.15.8"            % "test"
  private val h2                             = "com.h2database"                       % "h2"                              % "1.4.198"           % "test"
  private val jmh                            = "org.openjdk.jmh"                      % "jmh-core"                        % "1.21"

  private val junit                          = "org.junit.jupiter"                    % "junit-jupiter-api"               % "5.4.0"             % "test"
  private val jetty                          = "org.eclipse.jetty"                    % "jetty-server"                    % "9.4.15.v20190215"  % "test"
