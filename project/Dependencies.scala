...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                % "4.1.65.Final"
  ...
  private val quicklens                      = "com.softwaremill.quicklens"          %% "quicklens"                       % "1.7.3"
  ...
  private val jetty                          = "org.eclipse.jetty"                    % "jetty-server"                    % "9.4.41.v20210516"  % Test
