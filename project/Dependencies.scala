...
object Dependencies {
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                  % "2.17.1"
  ...
  private val awsSecretsManager              = "software.amazon.awssdk"               % "secretsmanager"                    % "2.26.12"
  ...
  private val gatlingGrpcVersion = "3.11.4"
  private val gatlingMqttVersion = "3.11.4"
