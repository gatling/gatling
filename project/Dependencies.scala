...
object Dependencies {
  ...
  private val nettyHttp                      = "io.netty"                                                     % "netty-codec-http"         % "4.2.5.Final"
  ...
  private val nettyTcNative                  = nettyHttp.organization                                         % "netty-tcnative-classes"   % "2.0.73.Final"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"                                   % "jackson-databind"         % "2.20.0"
  ...
  private val mockitoCore         = "org.mockito"                     % "mockito-core"    % "5.19.0"   % Test
  ...
  private val jetty                 = "org.eclipse.jetty"    % "jetty-server"            % "12.1.0"                                      % Test
