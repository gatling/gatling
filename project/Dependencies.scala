...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                % "4.1.23.Final"
  ...
  private val saxon                          = "net.sf.saxon"                         % "Saxon-HE"                        % "9.8.0-11"
  ...
  private val sfm                            = ("org.simpleflatmapper"                % "sfm-csv"                         % "3.17.4")
  ...
  private val zinc                           = ("org.scala-sbt"                      %% "zinc"                            % "1.1.5")
  ...
  private val mockitoCore                    = "org.mockito"                          % "mockito-core"                    % "2.18.0"            % "test"
