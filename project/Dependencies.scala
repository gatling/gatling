...
object Dependencies {
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                  % "2.15.1"
  ...
  private val quicklens                      = "com.softwaremill.quicklens"          %% "quicklens"                         % "1.9.4"
  ...
  private val gatlingEnterprisePluginCommons = "io.gatling"                           % "gatling-enterprise-plugin-commons" % "1.5.3"
  ...
  private val junit                          = "org.junit.jupiter"                    % "junit-jupiter-api"                 % "5.9.3"             % Test
  ...
  // Docs dependencies
  private val commonsIo                      = "commons-io"                           % "commons-io"                        % "2.12.0"
