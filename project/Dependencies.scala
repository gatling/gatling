...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                % "4.1.27.Final"
  ...
  private val sfm                            = ("org.simpleflatmapper"                % "sfm-csv"                         % "3.19.0")
  ...
  private val jsonpath                       = "io.gatling"                          %% "jsonpath"                        % "0.6.12"
  ...
  private val zinc                           = ("org.scala-sbt"                      %% "zinc"                            % "1.1.7")
  ...
  private val pebble                         = "io.pebbletemplates"                   % "pebble"                          % "3.0.2"
  ...
  private val mockitoCore                    = "org.mockito"                          % "mockito-core"                    % "2.19.1"            % "test"
  private val activemqBroker                 = "org.apache.activemq"                  % "activemq-broker"                 % "5.15.4"            % "test"
