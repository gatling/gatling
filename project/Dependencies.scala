...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                  % "4.1.85.Final"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                  % "2.14.0"
  ...
  private val mockitoCore                    = "org.mockito"                          % "mockito-core"                      % "4.8.1"             % Test
