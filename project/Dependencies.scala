...
object Dependencies { 
  ...
  private val ahc                           = "org.asynchttpclient"                    % "async-http-client"             % "2.1.0-alpha21"
  private val ahcNettyUtils                 = "org.asynchttpclient"                    % "async-http-client-netty-utils" % ahc.revision
  private val netty                         = "io.netty"                               % "netty-codec-http"              % "4.1.13.Final"
  private val nettyNativeTransport          = "io.netty"                               % "netty-transport-native-epoll"  % netty.revision classifier "linux-x86_64"
  private val akkaActor                     = "com.typesafe.akka"                     %% "akka-actor"                    % "2.5.3"
  private val akkaSlf4j                     = "com.typesafe.akka"                     %% "akka-slf4j"                    % akkaActor.revision
  private val config                        = "com.typesafe"                           % "config"                        % "1.3.1"
  private val saxon                         = "net.sf.saxon"                           % "Saxon-HE"                      % "9.8.0-2"
  private val slf4jApi                      = "org.slf4j"                              % "slf4j-api"                     % "1.7.25"
  private val fastring                      = "com.dongxiguo"                         %% "fastring"                      % "0.3.1"
  private val scopt                         = "com.github.scopt"                      %% "scopt"                         % "3.6.0"
  private val scalaLogging                  = "com.typesafe.scala-logging"            %% "scala-logging"                 % "3.7.1"
  private val jackson                       = "com.fasterxml.jackson.core"             % "jackson-databind"              % "2.8.9"
  ...
  private val caffeine                      = "com.github.ben-manes.caffeine"          % "caffeine"                      % "2.5.3"
