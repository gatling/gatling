...
object Dependencies {
  ...
  private val nettyBoringSsl                 = netty.organization                     % "netty-tcnative-boringssl-static" % "2.0.39.Final"
  ...
  private val zinc                           = ("org.scala-sbt"                      %% "zinc"                            % "1.5.2")
    .exclude("org.jline", "jline")
  ...
  private val activemqBroker                 = ("org.apache.activemq"                 % "activemq-broker"                 % "5.16.2"            % Test)
