...
object Dependencies {
  ...
  private val logback                        = "ch.qos.logback"                       % "logback-classic"                   % "1.5.11"
  ...
  private val junit                          = "org.junit.jupiter"                    % "junit-jupiter-api"                 % "5.11.2"            % Test
  ...
  private val awsSecretsManager              = "software.amazon.awssdk"               % "secretsmanager"                    % "2.28.21"
