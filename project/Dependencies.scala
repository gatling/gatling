...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                  % "4.1.80.Final"
  ...
  private val brotli4j                       = "com.aayushatharva.brotli4j"           % "brotli4j"                          % "1.8.0"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                  % "2.13.4"
  ...
  private val bouncyCastle                   = "io.gatling"                           % "gatling-recorder-bc-shaded"        % "1.71.1"
  private val quicklens                      = "com.softwaremill.quicklens"          %% "quicklens"                         % "1.8.10"
  ...
  private val gatlingEnterprisePluginCommons = "io.gatling"                           % "gatling-enterprise-plugin-commons" % "1.4.7"
  ...
  private val mockitoCore                    = "org.mockito"                          % "mockito-core"                      % "4.7.0"             % Test
  ...
  private val junit                          = "org.junit.jupiter"                    % "junit-jupiter-api"                 % "5.9.0"             % Test
  private val junitEngine                    = junit.withName("junit-jupiter-engine")
  private val jupiterInterface               = "net.aichler"                          % "jupiter-interface"                 % "0.11.0"            % Test

  private val jetty                          = "org.eclipse.jetty"                    % "jetty-server"                      % "9.4.48.v20220622"  % Test
