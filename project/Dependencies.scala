...
object Dependencies {
  ...
  private val akka                           = "com.typesafe.akka"                   %% "akka-actor"                      % "2.6.15"
  ...
  private val zinc                           = ("org.scala-sbt"                      %% "zinc"                            % "1.5.5")
    .exclude("org.jline", "jline")
  ...
  private val mockitoCore                    = "org.mockito"                          % "mockito-core"                    % "3.11.1"             % Test
  ...
  private val jetty                          = "org.eclipse.jetty"                    % "jetty-server"                    % "9.4.42.v20210604"  % Test
