...
object Dependencies { 
  ...
  private val ahc                           = "org.asynchttpclient"                    % "async-http-client"            % "2.0.0-alpha23"
  private val netty4                        = "io.netty"                               % "netty-codec-http"             % "4.0.33.Final"
  ...
  private val jackson                       = "com.fasterxml.jackson.core"             % "jackson-databind"             % "2.6.3"
