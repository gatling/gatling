...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                % "4.1.31.Final"
  ...
  private val nettyBoringSsl                 = netty.organization                     % "netty-tcnative-boringssl-static" % "2.0.19.Final"
  private val activation                     = "com.sun.activation"                   % "javax.activation"                % "1.2.0"
  private val akka                           = "com.typesafe.akka"                   %% "akka-actor"                      % "2.5.18"
  ...
  private val sfm                            = ("org.simpleflatmapper"                % "lightning-csv"                   % "6.0.9")
  ...
  private val mockitoCore                    = "org.mockito"                          % "mockito-core"                    % "2.23.0"            % "test"
