...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                  % "4.1.78.Final"
  ...
  private val zinc                           = ("org.scala-sbt"                      %% "zinc"                              % "1.7.0")
    .exclude("org.jline", "jline")
  ...
  private val gatlingEnterprisePluginCommons = "io.gatling"                           % "gatling-enterprise-plugin-commons" % "1.4.3"
