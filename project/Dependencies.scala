...
object Dependencies {
  ...
  private val gatlingSharedModel             = "io.gatling"                          %% "gatling-shared-model"              % "0.0.3"
  ...
  private val nettyIoUringLinuxX86           = "io.netty.incubator"                   % "netty-incubator-transport-native-io_uring" % "0.0.24.Final" classifier "linux-x86_64"
  ...
  private val nettyTcNative                  = netty.organization                     % "netty-tcnative-classes"            % "2.0.62.Final"
  ...
  private val brotli4j                       = "com.aayushatharva.brotli4j"           % "brotli4j"                          % "1.13.0"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                  % "2.16.0"
  ...
  private val spotbugs                       = "com.github.spotbugs"                  % "spotbugs-annotations"              % "4.8.1"
  ...
  private val jetty                          = "org.eclipse.jetty"                    % "jetty-server"                      % "9.4.53.v20231009"  % Test
  private val jettyProxy                     = jetty.organization                     % "jetty-proxy"                       % jetty.revision      % Test

  // Docs dependencies
  private val commonsIo                      = "commons-io"                           % "commons-io"                        % "2.15.0"
