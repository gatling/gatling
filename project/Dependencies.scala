...
object Dependencies { 
  ...
  private val ahc                            = "com.ning"                   % "async-http-client"      % "1.8.11"
  ...
  private val jackson                        = "com.fasterxml.jackson.core" % "jackson-databind"       % "2.4.1.1"
  private val boon                           = "io.fastjson"                % "boon"                   % "0.21"
