...
object Dependencies {
  ...
  private val logback       = "ch.qos.logback"                % "logback-classic"            % "1.5.19"
  ...
  private val jupiterInterface      = "com.github.sbt.junit" % "jupiter-interface"       % "0.15.2"       % Test
  private val jetty                 = "org.eclipse.jetty"    % "jetty-server"            % "12.1.2"       % Test
