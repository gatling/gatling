...
object Dependencies { 
  ...
  private val ahc                           = "org.asynchttpclient"                    % "async-http-client-netty3-provider"   % "2.0.0-alpha5"
  ...
  private val saxon                         = "net.sf.saxon"                           % "Saxon-HE"                            % "9.6.0-6"
  ...
  private val jackson                       = "com.fasterxml.jackson.core"             % "jackson-databind"                    % "2.6.0-rc2"
  ...
  private val boopickle                     = "me.chrons"                             %% "boopickle"                           % "1.0.0"
