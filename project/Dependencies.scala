...
object Dependencies {
  ...
  private val nettyHttp                      = "io.netty"                      % "netty-codec-http"            % "4.2.14.Final"
  ...
  private val nettyTcNative                  = "io.netty"                      % "netty-tcnative-classes"      % "2.0.77.Final"
  ...
  private val config                         = "com.typesafe"                  % "config"                      % "1.4.8"
  private val fastUuid                       = "com.eatthepath"                % "fast-uuid"                   % "0.2.0"
  private val jackson                        = "com.fasterxml.jackson.core"    % "jackson-databind"            % "2.21.4"
  ...
  // Test dependencies
  private val activemqBroker                 = "org.apache.activemq"           % "activemq-broker"             % "6.2.6"        % Test
  private val h2                             = "com.h2database"                % "h2"                          % "2.4.240"      % Test
  private val jetty                          = "org.eclipse.jetty"             % "jetty-server"                % "12.1.9"       % Test
  private val jettyProxy                     = jetty.withName("jetty-proxy")
  private val junit                          = "org.junit.jupiter"             % "junit-jupiter-api"           % "6.1.0"        % Test
