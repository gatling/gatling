...
object Dependencies {
  ...
  private val nettyHttp                      = "io.netty"                                                     % "netty-codec-http"         % "4.2.10.Final"
  ...
  private val nettyTcNative                  = nettyHttp.organization                                         % "netty-tcnative-classes"   % "2.0.75.Final"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"                                   % "jackson-databind"         % "2.21.1"
  ...
  private val logback       = "ch.qos.logback"                % "logback-classic"            % "1.5.32"
  ...
  private val activemqBroker      = "org.apache.activemq"             % "activemq-broker" % "6.2.1"    % Test
  ...
  private val jupiterInterface      = "com.github.sbt.junit" % "jupiter-interface"       % "0.17.1"       % Test
  private val jetty                 = "org.eclipse.jetty"    % "jetty-server"            % "12.1.7"       % Test
