...
object Dependencies {
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                  % "2.18.1"
  ...
  private val junit                          = "org.junit.jupiter"                    % "junit-jupiter-api"                 % "5.11.3"            % Test
  ...
  private val awsSecretsManager              = "software.amazon.awssdk"               % "secretsmanager"                    % "2.28.29"
