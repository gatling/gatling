...
object Dependencies {
  ...
  private val xmlresolver                    = "org.xmlresolver"                                              % "xmlresolver"              % "6.0.16"
  ...
  private val junit       = "org.junit.jupiter" % "junit-jupiter-api" % "5.12.2" % Test
  ...
  private val jetty                 = "org.eclipse.jetty"    % "jetty-server"            % "12.0.21"                                     % Test
