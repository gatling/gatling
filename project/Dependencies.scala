...
object Dependencies {
  ...
  private val nettyTcNative                  = "io.netty"                      % "netty-tcnative-classes"      % "2.0.75.Final"
  ...
  private val brotli4j                       = "com.aayushatharva.brotli4j"    % "brotli4j"                    % "1.22.0"
  ...
  // Test dependencies
  private val activemqBroker                 = "org.apache.activemq"           % "activemq-broker"             % "6.2.3"        % Test
  private val h2                             = "com.h2database"                % "h2"                          % "2.4.240"      % Test
  private val jetty                          = "org.eclipse.jetty"             % "jetty-server"                % "12.1.8"       % Test
