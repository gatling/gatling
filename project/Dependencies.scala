...
object Dependencies { 
	...
	private val ahc                            = "com.ning"                   % "async-http-client"  % "1.8.7"
	...
	private val jackson                        = "com.fasterxml.jackson.core" % "jackson-databind"   % "2.3.3"
	private val boon                           = "io.fastjson"                % "boon"               % "0.14"
	...
	private val zinc                           = "com.typesafe.zinc"          % "zinc"               % "0.3.2-M3"
