...
object Dependencies {
  ...
  private val akka                           = "com.typesafe.akka"                   %% "akka-actor"                      % "2.5.24"
  ...
  private val sfm                            = ("org.simpleflatmapper"                % "lightning-csv"                   % "7.0.2")
  ...
  private val zinc                           = ("org.scala-sbt"                      %% "zinc"                            % "1.3.0-M9")
