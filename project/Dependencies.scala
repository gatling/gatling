...
object Dependencies {
  ...
  private val gatlingSharedModel             = "io.gatling"                          %% "gatling-shared-model"              % "0.0.7"
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                  % "4.1.113.Final"
  ...
  private val nettyTcNative                  = netty.organization                     % "netty-tcnative-classes"            % "2.0.66.Final"
  ...
  private val brotli4j                       = "com.aayushatharva.brotli4j"           % "brotli4j"                          % "1.17.0"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                  % "2.17.2"
  ...
  private val logback                        = "ch.qos.logback"                       % "logback-classic"                   % "1.5.8"
  ...
  private val activemqBroker                 = ("org.apache.activemq"                 % "activemq-broker"                   % "5.18.5"            % Test)
  ...
  private val junit                          = "org.junit.jupiter"                    % "junit-jupiter-api"                 % "5.11.0"            % Test
  ...
  private val awsSecretsManager              = "software.amazon.awssdk"               % "secretsmanager"                    % "2.28.1"
  ...
  private val gatlingGrpcVersion = "3.12.0.1"
  private val gatlingMqttVersion = "3.12.0"
