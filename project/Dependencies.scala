...
object Dependencies { 
  ...
  private val ahc                            = "org.asynchttpclient"                    % "async-http-client"             % "2.1.0-alpha26"
  ...
  private val sfm                            = ("org.simpleflatmapper"                  % "sfm-csv"                       % "3.14.2")
  ...
  private val zinc                           = ("org.scala-sbt"                        %% "zinc"                          % "1.0.5")
  ...
  private val caffeine                       = "com.github.ben-manes.caffeine"          % "caffeine"                      % "2.6.0"
  ...
  private val mockitoCore                    = "org.mockito"                            % "mockito-core"                 % "2.12.0"            % "test"
