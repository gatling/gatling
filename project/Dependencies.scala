...
object Dependencies {
  ...
  private val scalaSwing                     = "org.scala-lang.modules"                %% "scala-swing"                   % "2.0.2"
  ...
  private val ahc                            = "org.asynchttpclient"                    % "async-http-client"             % "2.4.1"
  ...
  private val sfm                            = ("org.simpleflatmapper"                  % "sfm-csv"                       % "3.15.9")
