...
object Dependencies {
  ...
  private val ahc                            = "org.asynchttpclient"                    % "async-http-client"             % "2.4.4"
  ...
  private val sfm                            = ("org.simpleflatmapper"                  % "sfm-csv"                       % "3.16.1")
  ...
  private val zinc                           = ("org.scala-sbt"                        %% "zinc"                          % "1.1.3")
