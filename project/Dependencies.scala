...
object Dependencies { 
  ...
  private val ahc                           = "org.asynchttpclient"                    % "async-http-client"            % "2.0.10"
  private val netty                         = "io.netty"                               % "netty-codec-http"             % "4.0.39.Final"
  ...
  private val saxon                         = "net.sf.saxon"                           % "Saxon-HE"                     % "9.7.0-6"
  ...
  private val jackson                       = "com.fasterxml.jackson.core"             % "jackson-databind"             % "2.7.5"
  private val jacksonCsv                    = "com.fasterxml.jackson.dataformat"       % "jackson-dataformat-csv"       % jackson.revision
  private val boon                          = "io.advantageous.boon"                   % "boon-json"                    % "0.6.4"
  ...
  private val zinc                          = "com.typesafe.zinc"                      % "zinc"                         % "0.3.11" exclude("org.scala-lang", "scala-compiler")
