...
object Dependencies { 
  ...
  private val ahc                           = "org.asynchttpclient"                    % "async-http-client"            % "2.0.0-RC8"
  ...
  private val slf4jApi                      = "org.slf4j"                              % "slf4j-api"                    % "1.7.14"
  ...
  private val boon                          = "io.advantageous.boon"                   % "boon-json"                    % "0.5.6.RELEASE"
  ...
  private val quicklens                     = "com.softwaremill.quicklens"            %% "quicklens"                    % "1.4.4"
