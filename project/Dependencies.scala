...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                  % "4.1.92.Final"
  ...
  private val nettyIoUringLinuxX86           = "io.netty.incubator"                   % "netty-incubator-transport-native-io_uring" % "0.0.20.Final" classifier "linux-x86_64"
  ...
  private val quicklens                      = "com.softwaremill.quicklens"          %% "quicklens"                         % "1.9.2"
