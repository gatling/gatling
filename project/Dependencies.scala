...
object Dependencies { 
  ...
  private val jackson_scala                  = "com.fasterxml.jackson.module"   % "jackson-module-scala_2.10"    % "2.3.2"      exclude ("com.fasterxml.jackson.core", "jackson-annotations")
  ...
  val tcpDependencies = jackson_scala
