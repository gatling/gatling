...
object Dependencies {
  ...
  private val nettyHttp                      = "io.netty"                                                     % "netty-codec-http"         % "4.2.9.Final"
  ...
  private val logback       = "ch.qos.logback"                % "logback-classic"            % "1.5.26"
  ...
  private val pebble        = "io.pebbletemplates"            % "pebble"                     % "4.1.0"
  ...
  private val jetty                 = "org.eclipse.jetty"    % "jetty-server"            % "12.1.5"       % Test
