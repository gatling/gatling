...
object Dependencies {
  ...
  private val gatlingSharedCli               = "io.gatling"                           % "gatling-shared-cli"                % "0.0.4"
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                  % "4.1.115.Final"
  ...
  private val awsSecretsManager              = "software.amazon.awssdk"               % "secretsmanager"                    % "2.29.17"
