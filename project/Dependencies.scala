...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                  % "4.1.112.Final"
  ...
  private val jetty                          = "org.eclipse.jetty"                    % "jetty-server"                      % "9.4.55.v20240627"  % Test
  ...
  private val awsSecretsManager              = "software.amazon.awssdk"               % "secretsmanager"                    % "2.27.12"
