...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                % "4.1.41.Final"
  ...
  private val akka                           = "com.typesafe.akka"                   %% "akka-actor"                      % "2.5.25"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                % "2.9.10"
  ...
  private val zinc                           = ("org.scala-sbt"                      %% "zinc"                            % "1.3.0")
  ...
  private val bouncyCastle                   = "org.bouncycastle"                     % "bcpkix-jdk15on"                  % "1.63"
  ...
  private val scalaCheck                     = "org.scalacheck"                      %% "scalacheck"                      % "1.14.1"            % "test"
