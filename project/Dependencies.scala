...
object Dependencies {
  ...
  private val zinc                           = ("org.scala-sbt"                      %% "zinc"                              % "1.9.1")
    .exclude("org.jline", "jline")
  ...
  private val bouncyCastle                   = "io.gatling"                           % "gatling-recorder-bc-shaded"        % "1.74"
  ...
  private val gatlingEnterprisePluginCommons = "io.gatling"                           % "gatling-enterprise-plugin-commons" % "1.5.5"
