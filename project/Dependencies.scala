...
object Dependencies {
  ...
  private val sfm                            = ("org.simpleflatmapper"                % "sfm-csv"                         % "3.18.3")
  ...
  private val pebble                         = "io.pebbletemplates"                   % "pebble"                          % "3.0.0.BETA01"
  ...
  private val mockitoCore                    = "org.mockito"                          % "mockito-core"                    % "2.19.0"            % "test"
