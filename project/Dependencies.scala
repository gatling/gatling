...
object Dependencies {
	...
	private val saxon             = "net.sf.saxon"          % "Saxon-HE"           % "9.5.1-2"
	...
	private val jsonPath          = "com.jayway.jsonpath"   % "json-path"          % "0.8.2.fix24"
	private val commonsMath       = "org.apache.commons"    % "commons-math3"      % "3.2"
	private val jsoup             = "org.jsoup"             % "jsoup"              % "1.7.2"
	private val joddLagarto       = "org.jodd"              % "jodd-lagarto"       % "3.4.5"
