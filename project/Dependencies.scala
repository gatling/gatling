...
object Dependencies {
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                  % "2.17.1" exclude("net.bytebuddy", "byte-buddy")
  ...
  private val awsSecretsManager              = "software.amazon.awssdk"               % "secretsmanager"                    % "2.25.43"
