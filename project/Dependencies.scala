...
object Dependencies {
  ...
  private val sfm                            = ("org.simpleflatmapper"                % "lightning-csv"                   % "6.4.2")
  ...
  private val mockitoCore                    = "org.mockito"                          % "mockito-core"                    % "2.25.1"            % "test"
  ...
  private val junit                          = "org.junit.jupiter"                    % "junit-jupiter-api"               % "5.4.1"             % "test"
