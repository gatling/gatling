...
object Dependencies {
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                  % "2.17.0" exclude("net.bytebuddy", "byte-buddy")
  ...
  private val spotbugs                       = "com.github.spotbugs"                  % "spotbugs-annotations"              % "4.8.4"
  ...
  private val gatlingGrpcVersion = "3.10.5.1"
