...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                % "4.1.50.Final"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"           % "jackson-databind"                % "2.11.0"
  ...
  private val caffeine                       = "com.github.ben-manes.caffeine"        % "caffeine"                        % "2.8.4"
  private val bouncyCastle                   = "org.bouncycastle"                     % "bcpkix-jdk15on"                  % "1.65"
  ...
  private val scalaTestScalacheck            = "org.scalatestplus"                   %% "scalacheck-1-14"                 % "3.2.0.0"           % "test"
  private val scalaTestMockito               = scalaTestScalacheck.organization      %% "mockito-3-2"                     % "3.1.2.0"           % "test"
  ...
  private val mockitoCore                    = "org.mockito"                          % "mockito-core"                    % "3.3.3"             % "test"
  private val activemqBroker                 = ("org.apache.activemq"                 % "activemq-broker"                 % "5.15.13"           % "test")
  ...
  private val jetty                          = "org.eclipse.jetty"                    % "jetty-server"                    % "9.4.29.v20200521"  % "test"
