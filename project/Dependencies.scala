...
object Dependencies {
  ...
  private val h2                             = "com.h2database"                       % "h2"                                % "2.3.230"           % Test
  private val jmh                            = "org.openjdk.jmh"                      % "jmh-core"                          % "1.27"              % Test

  private val junit                          = "org.junit.jupiter"                    % "junit-jupiter-api"                 % "5.10.3"            % Test
  ...
  private val awsSecretsManager              = "software.amazon.awssdk"               % "secretsmanager"                    % "2.26.25"
