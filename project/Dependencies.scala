...
object Dependencies {
  ...
  private val nettyHttp                      = "io.netty"                      % "netty-codec-http"            % "4.2.18.Final"
  ...
  private val nettyTcNative                  = "io.netty"                      % "netty-tcnative-classes"      % "2.0.84.Final"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"    % "jackson-databind"            % "2.22.2"
  ...
  private val logback                        = "ch.qos.logback"                % "logback-classic"             % "1.6.3"
  ...
  private val h2                             = "com.h2database"                % "h2"                          % "2.5.250"      % Test
  private val jetty                          = "org.eclipse.jetty"             % "jetty-server"                % "12.1.13"      % Test
  private val jettyProxy                     = jetty.withName("jetty-proxy")
  private val junit                          = "org.junit.jupiter"             % "junit-jupiter-api"           % "6.1.3"        % Test
