...
object Dependencies {
  ...
  private val akka                           = "com.typesafe.akka"                   %% "akka-actor"                      % "2.5.22"
  ...
  private val sfm                            = ("org.simpleflatmapper"                % "lightning-csv"                   % "6.6.2")
  ...
  private val joddJson                       = "org.jodd"                             % "jodd-json"                       % "5.0.11"
