...
object Dependencies { 
  ...
  private val ahc                           = "org.asynchttpclient"                    % "async-http-client"            % "2.0.6"
  private val netty                         = "io.netty"                               % "netty-codec-http"             % "4.0.37.Final"
  ...
  private val saxon                         = "net.sf.saxon"                           % "Saxon-HE"                     % "9.7.0-5"
  ...
  private val boon                          = "io.advantageous.boon"                   % "boon-json"                    % "0.6.2"
  private val jsonpath                      = "io.gatling"                            %% "jsonpath"                     % "0.6.7"
  private val joddLagarto                   = "org.jodd"                               % "jodd-lagarto"                 % "3.7.1"
  private val boopickle                     = "me.chrons"                             %% "boopickle"                    % "1.2.0"
