...
object Dependencies {
  ...
  private val netty                          = "io.netty"                             % "netty-codec-http"                  % "4.1.104.Final"
  ...
  private val brotli4j                       = "com.aayushatharva.brotli4j"           % "brotli4j"                          % "1.15.0"
  ...
  private val slf4jApi                       = "org.slf4j"                            % "slf4j-api"                         % "2.0.10"
