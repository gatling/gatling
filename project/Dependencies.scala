...
object Dependencies {
  ...
  private val nettyTcNative                  = "io.netty"                      % "netty-tcnative-classes"      % "2.0.79.Final"
  ...
  private val jackson                        = "com.fasterxml.jackson.core"    % "jackson-databind"            % "2.22.0"
  ...
  private val logback                        = "ch.qos.logback"                % "logback-classic"             % "1.5.37"
  ...
  private val jetty                          = "org.eclipse.jetty"             % "jetty-server"                % "12.1.10"       % Test
