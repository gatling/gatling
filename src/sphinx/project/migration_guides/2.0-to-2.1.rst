...
Either generate a new project with the 2.1 archetype, or override your classes with the ones `here <https://github.com/gatling/gatling-maven/tree/gatling-maven-parent-2.1.1/gatling-highcharts-maven-archetype/src/main/scala>`_.
