...
.. warning::
  ...
  This behavior makes perfect sense when the load you're modeling is internet traffic. Then, you might consider scale out, for example with FrontLine, our Enterprise product.
