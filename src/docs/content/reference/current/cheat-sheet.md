    ...
    sections:
      ...
      - title: Errors handling
        ...
        - keyword: exitHereIfFailed
          description: If there were an error during execution, the scenario should stop at this point.
          ...
          - keyword: xpath
            ...
            syntax:
              ...
              - signature: (expression, namespaces)
                description: If you want to use namespaces in your XPATH expression, you should specify them. The <i>namespaces</i> are specified thanks to a List[(prefix,uri)]:<br>List(('c','http://core'), ('f','http://format')).
              - signature: (Session => String)
      ...
      - title: Check transformer
        functions:
          ...
          - keyword: transform
            ...
            syntax:
              - signature: (A => B)
                description: This function is optional. It can be useful sometimes to apply a transformation on the extracted values before validating them. In this function, type <i>A</i> is the type of the find operation (either <i>String</i>, <i>List[String]</i> or <i>Int</i>). Type B is whatever you want it to be (could be a case class for example)
      ...
      - title: Commons
        functions:
          ...
          - keyword: selector
            ...
            syntax:
              - signature: (selector)
                description: Where <i>selector</i> is the name of the selector
