...
For more information on the new Injection DSL, please consult the [Injection DSL reference documentation](||< ref "docs/simulation-inject" >||).
...
For more information, see the [Request bodies reference section](||< ref "docs/http-request-body" >||).
