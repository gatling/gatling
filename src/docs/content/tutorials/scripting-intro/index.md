...
{{< include-code "ScriptingIntro1Sample#setup-the-file" java js >}}
...
{{< include-code "ScriptingIntro1Sample#extend-the-simulation-class" java js >}}
...
{{< include-code "ScriptingIntro2Sample#define-the-protocol-class" java js >}}
...
{{< include-code "ScriptingIntro3Sample#write-the-scenario" java js >}}
...
{{< include-code "ScriptingIntro4Sample#define-the-injection-profile" java js >}}
...
{{< include-code "ComputerDatabaseSimulation#full-example" java js >}}
